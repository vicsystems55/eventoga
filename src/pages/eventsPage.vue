    ...
    <div class="min-h-screen ambient-bg text-white">
        ...
        <section class="relative w-full px-4 py-12 md:px-6 md:py-16 lg:px-8">
            <div class="mx-auto max-w-7xl">
                <div class="text-center max-w-3xl mx-auto">
                    <h1
                        class="text-4xl md:text-5xl lg:text-6xl font-black mb-4 bg-gradient-to-r from-orange-500 to-purple-500 bg-clip-text text-transparent">
                        Discover Amazing Events
                    </h1>
                    <p class="text-gray-400 text-lg mb-8">Find and book the best concerts, conferences, parties, and
                        more in your city</p>

                    <!-- Search Bar -->
                    <div class="relative">
                        <div
                            class="flex items-center gap-2 bg-black/50 rounded-2xl border border-purple-500/30 p-2 backdrop-blur-sm">
                            <div class="flex-1 flex items-center gap-2 px-4 py-3">
                                ...
                                <input v-model="searchQuery" type="text"
                                    ...
                                    class="w-full bg-transparent outline-none text-white" @input="filterEvents" />
                            </div>
                        ...
                        <div class="sticky top-4 space-y-6">
                            ...
                            <div class="flex items-center justify-between lg:hidden">
                                <button @click="showFilters = !showFilters"
                                    class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-xl">
                            ...
                            <div :class="['space-y-6', showFilters ? 'block' : 'hidden lg:block']">
                                ...
                                <div class="bg-black/30 rounded-2xl border border-purple-500/30 p-5 backdrop-blur-sm">
                                    ...
                                    <div class="space-y-2">
                                        <label v-for="category in categories" :key="category"
                                            class="flex items-center gap-2 cursor-pointer hover:text-orange-500 transition">
                                ...
                                <div class="bg-black/30 rounded-2xl border border-purple-500/30 p-5 backdrop-blur-sm">
                                    ...
                                    <div class="space-y-3">
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" value="all" v-model="dateFilter" @change="filterEvents"
                                                class="text-orange-500">
                                            <span class="text-sm">All Dates</span>
                                        </label>
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" value="today" v-model="dateFilter"
                                                @change="filterEvents" class="text-orange-500">
                                            <span class="text-sm">Today</span>
                                        </label>
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" value="week" v-model="dateFilter" @change="filterEvents"
                                                class="text-orange-500">
                                            <span class="text-sm">This Week</span>
                                        </label>
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" value="month" v-model="dateFilter"
                                                @change="filterEvents" class="text-orange-500">
                                            <span class="text-sm">This Month</span>
                                        </label>
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" value="weekend" v-model="dateFilter"
                                                @change="filterEvents" class="text-orange-500">
                                ...
                                <div class="bg-black/30 rounded-2xl border border-purple-500/30 p-5 backdrop-blur-sm">
                                    ...
                                    <div class="space-y-3">
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" value="all" v-model="priceFilter" @change="filterEvents"
                                                class="text-orange-500">
                                        ...
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" value="under5k" v-model="priceFilter"
                                                @change="filterEvents" class="text-orange-500">
                                            <span class="text-sm">Under ₦5,000</span>
                                        </label>
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" value="5k-20k" v-model="priceFilter"
                                                @change="filterEvents" class="text-orange-500">
                                            <span class="text-sm">₦5,000 - ₦20,000</span>
                                        </label>
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" value="20k+" v-model="priceFilter"
                                                @change="filterEvents" class="text-orange-500">
                                ...
                                <div class="bg-black/30 rounded-2xl border border-purple-500/30 p-5 backdrop-blur-sm">
                                    ...
                                    <div class="space-y-2">
                                        <label v-for="rating in [4, 3, 2]" :key="rating"
                                ...
                                <button @click="clearFilters"
                                    class="w-full py-3 bg-white/5 rounded-xl font-semibold hover:bg-white/10 transition">
                                    Clear All Filters
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="hidden lg:flex justify-between items-center mb-6">
                            ...
                            <select v-model="sortBy" @change="sortEvents"
                                class="bg-black/50 border border-purple-500/30 rounded-xl px-4 py-2 text-sm outline-none">
                        ...
                        <div v-if="filteredEvents.length > 0"
                            ...
                            <div v-for="event in paginatedEvents" :key="event.id" data-aos="zoom-in"
                                ...
                                <div class="p-5">
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex gap-3">
                                            ...
                                            <div>
                                                <h3 class="font-black text-lg group-hover:text-orange-500 transition">{{
                                                    event.title }}</h3>
                                    ...
                                    <div class="flex items-center justify-between mt-4 pt-4 border-t border-white/10">
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500" v-if="event.price !== 'Free'">per ticket
                                            </p>
                                        </div>
                                        <div class="flex items-center gap-3">
                                            ...
                                            <button
                                                class="px-4 py-2 bg-orange-500 rounded-lg text-sm font-bold hover:bg-orange-600 transition">
                                                Book Now
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div v-else class="text-center py-20">
                            <svg class="w-24 h-24 mx-auto text-gray-600 mb-4" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <button @click="clearFilters"
                                class="mt-4 px-6 py-2 bg-orange-500 rounded-xl font-bold hover:bg-orange-600 transition">
                                Clear Filters
                            </button>
                        </div>
        ...
        <Transition name="modal-fade">
            <div v-if="selectedEvent"
                ...
                @click="closeModal">
                <div class="relative max-w-4xl w-full max-h-[90vh] overflow-y-auto rounded-3xl bg-gradient-to-br from-[#0a0a0a] to-[#050505] border border-orange-500/30 shadow-2xl"
                    @click.stop>
                    <!-- Close Button -->
                    <button @click="closeModal"
                        class="absolute top-4 right-4 z-20 w-10 h-10 rounded-full bg-black/50 backdrop-blur flex items-center justify-center text-white hover:bg-orange-500 transition">
                        ✕
                    </button>
                                ...
                                <div class="space-y-4">
                                    <div class="bg-orange-500/10 rounded-2xl p-5 border border-orange-500/30">
                                        <div class="text-center mb-4">
                                            ...
                                            <p class="text-sm text-gray-400" v-if="selectedEvent.price !== 'Free'">per
                                                ticket</p>
                                        </div>
                                        ...
                                        <div class="space-y-3">
                                            <div v-if="selectedEvent.price !== 'Free'"
                                                ...
                                                <span>Quantity:</span>
                                                <div class="flex items-center gap-3">
                                                    <button @click="ticketQuantity--" :disabled="ticketQuantity <= 1"
                                                        class="w-8 h-8 rounded-lg bg-white/10 hover:bg-orange-500 transition disabled:opacity-50">-</button>
                                                    <span class="font-bold">{{ ticketQuantity }}</span>
                                                    <button @click="ticketQuantity++"
                                                        class="w-8 h-8 rounded-lg bg-white/10 hover:bg-orange-500 transition">+</button>
                                                </div>
                                            </div>
                                            ...
                                            <div v-if="selectedEvent.price !== 'Free'"
                                                ...
                                                <span class="text-xl font-black text-orange-500">{{
                                                    calculateTotal(selectedEvent.price) }}</span>
                                            </div>

                                            <button
                                                class="w-full py-3 bg-orange-500 rounded-xl font-black hover:bg-orange-600 transition">
                                                Book Now
                                            </button>
                                        </div>
                                    </div>
